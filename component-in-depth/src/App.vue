...
import AppPropsObject from './components/AppPropsObject.vue';
import ComponentEmitEventTemplate from './components/ComponentEmitEventTemplate.vue';
import ComponentEmitEventScriptSetup from './components/ComponentEmitEventScriptSetup.vue';
...
<template>
  <div class="container">
    ...
    <AppPropsLiteral
      v-if="view === 'literal'"
      view-title="좋아하는 과일은?(단순 문자열(literal) 전달)"
    />
    <AppPropsObject
      v-if="view === 'object'"
